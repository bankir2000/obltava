  ...
  , jc = {
    ...
    data() {
        return {
            ...
            watchId: null,
            units: ['13 озкб','1 брОП НГУ','1 обр ТРО','101 обро ГШ','102 обр ТРО','1020 зрап','1021 зап','1025 зрап','1027 зрап','103 обр ТРО','104 обр ТРО','104 ОАБ','105 обр ТРО','105 ПрикЗ','106 обр ТРО','110 ак','112 обр ТРО','1121 зрап','1129 зрп','114 брта','114 обр ТРО','115 обр ТРО','116 обр ТРО','1163 бо','117 обр ТРО','118 обр ТРО','119 обр ТРО','120 обр ТРО','121 ак','121 обр ТРО','125 овмбр','127 обр ТРО','1322 АББ','138 ртбр','14 зрбр','156 зрп','164 ртбр','168 обр ТРО','169 ПРТБ','172 брез','178 брез','17 БАТЗ','1827 ЦАБО','19 об НГУ','2 обр НГУ','20 ОЦЛЗ','21 ак','210 ОШП','21 обр НГУ','222 АББ','223 зрп','225 зрп','229 ОЦЗ','230 ОБЗ','232 ОБЗ','2320 ОЦЗ ВТМ','25 брТрА','2572 ОЦР ОВТ','27 обр НГУ','28 п НГУ','3 Арс АЗУ','302 зрбр','303 Арс','3097 ЦЗП','31 опз та ртз','31 п НГУ','332 Арс РОБ','3343 ОЦЗ ВТМ','36 п НГУ','37 п НГУ','38 п НГУ','39 брта','39 зрп','3 ПрикЗ','4 бр НГУ','40 брта','40 п НГУ','433 ОЦЗ ЗУ ОВТ','434 Арс','45 п НГУ','48 Арс','540 зрбр','6 АСБ','62 Арс Озб','630 озкб','631 озкб','635 озкб','637 озкб','638 озкб','642 озкб','643 озкб','644 озкб','645 озкб','646 озкб','650 озкб','72 омбр','831 брта','90 АББ','9 ПрикЗ','94 ЦЗП','96 зрбр','ГУР','ДПСУ','ДФТГ','НГУ','НПУ','ОПБр','ПвК Центр'],
            prefixes: ['МВГ','ВГ'],
    ...
    `Підрозділ: ${this.form.pidrozdil || "13 озкб"}`,
    this.form.pozivniyPrefix && this.form.sign ? `Позивний: ${this.form.pozivniyPrefix} ${this.form.sign}` : (this.form.sign ? `Позивний: ${this.form.sign}` : ""),
    ...
    this.form.time = `${time}`;
        ...
        loadInputFromLocalStorage() {
            this.form.pidrozdil = localStorage.getItem("pidrozdil") || "13 озкб",
            this.form.pozivniyPrefix = localStorage.getItem("pozivniyPrefix") || null,
    ...
    watch: {
        "form.pidrozdil": function(e) {
            localStorage.setItem("pidrozdil", e || "")
        },
        "form.pozivniyPrefix": function(e) {
            localStorage.setItem("pozivniyPrefix", e || "")
        },
...
function bu(e, t, n, s, r, o) {
    ...
    G(de, null, [F(i, {
        ...
        ref: "popup"
    }, null, 8, ["message"]), B("div", { class: "pb-4" }, [F(l, { for: "pidrozdil", value: "\u041f\u0456\u0434\u0440\u043e\u0437\u0434\u0456\u043b:" }), B("select", { id: "pidrozdil", class: "mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm", value: r.form.pidrozdil, onChange: t[50] || (t[50] = d => r.form.pidrozdil = d.target.value) }, [B("option", { value: "", disabled: true, hidden: true }, "\u041e\u0431\u0435\u0440\u0456\u0442\u044c \u0437\u0456 \u0441\u043f\u0438\u0441\u043a\u0443"), (Y(!0), G(de, null, cn(r.units, (d, p) => (Y(), G("option", { key: p, value: d }, We(d), 9, ["value"]))), 128))], 40, ["value", "onChange"])]), B("div", { class: "pb-4" }, [F(l, { value: "\u041f\u043e\u0437\u0438\u0432\u043d\u0438\u0439:" }), B("div", { class: "flex gap-2 mt-1" }, [B("select", { class: "w-1/3 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm", value: r.form.pozivniyPrefix, onChange: t[51] || (t[51] = d => r.form.pozivniyPrefix = d.target.value) }, [B("option", { value: "", disabled: true, hidden: true }, "\u041e\u0431\u0435\u0440\u0456\u0442\u044c"), (Y(!0), G(de, null, cn(r.prefixes, (d, p) => (Y(), G("option", { key: p, value: d }, We(d), 9, ["value"]))), 128))], 40, ["value", "onChange"]), F(c, { id: "sign", modelValue: r.form.sign, "onUpdate:modelValue": t[0] || (t[0] = d => r.form.sign = d), type: "text", class: "w-2/3" }, null, 8, ["modelValue"])])]), B("div", Uc, [F(l, {
        for: "target",
        value: "\u0426\u0456\u043b\u044c:"
    }), B("div", Bc, [(Y(!0),
