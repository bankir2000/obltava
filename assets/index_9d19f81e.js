...
function bu(e, t, n, s, r, o) {
    ...
    G(de, null, [F(i, {
        ...
        ref: "popup"
    }, null, 8, ["message"]), B("div", { class: "pb-4" }, [F(l, { for: "pidrozdil", value: "\u041f\u0456\u0434\u0440\u043e\u0437\u0434\u0456\u043b:" }), B("select", { id: "pidrozdil", class: "mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm", value: r.form.pidrozdil, onChange: t[36] || (t[36] = d => r.form.pidrozdil = d.target.value) }, [B("option", { value: "", disabled: true, hidden: true }, "\u041e\u0431\u0435\u0440\u0456\u0442\u044c \u0437\u0456 \u0441\u043f\u0438\u0441\u043a\u0443"), (Y(!0), G(de, null, cn(r.units, (d, p) => (Y(), G("option", { key: p, value: d }, We(d), 9, ["value"]))), 128))], 40, ["value", "onChange"])]), B("div", { class: "pb-4" }, [F(l, { value: "\u041f\u043e\u0437\u0438\u0432\u043d\u0438\u0439:" }), B("div", { class: "flex gap-2 mt-1" }, [B("select", { class: "w-1/3 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm", value: r.form.pozivniyPrefix, onChange: t[37] || (t[37] = d => r.form.pozivniyPrefix = d.target.value) }, [B("option", { value: "", disabled: true, hidden: true }, "\u041e\u0431\u0435\u0440\u0456\u0442\u044c"), (Y(!0), G(de, null, cn(r.prefixes, (d, p) => (Y(), G("option", { key: p, value: d }, We(d), 9, ["value"]))), 128))], 40, ["value", "onChange"]), F(c, { id: "sign", modelValue: r.form.sign, "onUpdate:modelValue": t[0] || (t[0] = d => r.form.sign = d), type: "text", class: "w-2/3" }, null, 8, ["modelValue"])])]), B("div", Uc, [F(l, {
        for: "target",
        value: "\u0426\u0456\u043b\u044c:"
    }), B("div", Bc, [(Y(!0),
